...
CREATE TABLE `pelicula_actores` (
  ...
  KEY `idActor` (`idActor`),
  CONSTRAINT `pelicula_actores_ibfk_1` FOREIGN KEY (`idPelicula`) REFERENCES `pelicula` (`idPelicula`),
  CONSTRAINT `pelicula_actores_ibfk_2` FOREIGN KEY (`idActor`) REFERENCES `actores` (`idActor`)
